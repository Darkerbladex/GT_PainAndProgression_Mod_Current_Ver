...
public class WorldGenDarkiumTree extends WorldGenAbstractTree {
	
	public static final IBlockState LOG = BlockInit.LOGS.getDefaultState().withProperty(BlockLogs.VARIANT, EnumHandler.EnumType.DARKIUM);
	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockLeaf.VARIANT, EnumHandler.EnumType.DARKIUM);
	
	private final int minHeight;
	
	public WorldGenDarkiumTree() {
